...
class DataGridViewPrinter
{
    ...
    private void DrawHeader(Graphics g)
    {
        ...
        if (IsWithPaging)
        {
            ...
            Font PageStringFont = new Font("IRYekan", 12, FontStyle.Regular, GraphicsUnit.Point);
        ...
        float ColumnWidth;
        for (int i = (int)mColumnPoints[mColumnPoint].GetValue(1) - 1; i >= (int)mColumnPoints[mColumnPoint].GetValue(0); i--)
        {
